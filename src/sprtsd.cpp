...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Emercoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  emercoind [options]                     " + _("Start Emercoin Core Daemon") + "\n";
    ...
    try
    {
        ...
        if (fCommandLine)
        {
            fprintf(stderr, "Error: There is no RPC client functionality in emercoind anymore. Use the emercoin-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
