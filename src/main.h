...
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 800000;
...
static const unsigned int DEFAULT_MAX_ORPHAN_TRANSACTIONS = 150;
...
static const unsigned int BLOCK_STALLING_TIMEOUT = 5;
